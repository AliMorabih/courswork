...
public class CityWorld {
    ...
    public ArrayList<City> getTopNPopulatedCityDistrict(Connection con) {
        try {
            // Create an SQL statement
            Statement stmt = con.createStatement();
    ...
    public ArrayList<City> getTopNPopulatedCityCountry(Connection con) {
        try {
            // Create an SQL statement
            Statement stmt = con.createStatement();
    ...
    public void printTopNPopulatedCityDistrict(ArrayList<City> cities, String filename) {
        // Check employees is not null
        if (cities == null) {
            System.out.println("No Cities");
            return;
    ...
    public void printgetTopNPopulatedCityCountry(ArrayList<City> cities, String filename) {
        // Check employees is not null
        if (cities == null) {
            System.out.println("No Cities");
            return;
    ...
    public void printTopNPopulatedContinent(ArrayList<City> cities, String filename) {
        // Check employees is not null
        if (cities == null) {
            System.out.println("No Cities");
            return;
